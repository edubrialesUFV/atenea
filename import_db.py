...
def cargar_datos(archivo_xlsx):
    ...
    for fila in hoja.iter_rows(min_row=2, values_only=True):
        ...
        nuevo_objeto_product = Producto(referencia=ref, proveedor = producto_proveedor, cantidad_minima_reaprovisionamiento=cant_min,precio= random.randint(50, 150), cantidad_stock=20)
